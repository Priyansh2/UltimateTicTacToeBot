...
class Player45:
    def __init__(self):
        self.grid = {'00': ['01', '10'], '01': ['00', '02'], '02': ['01', '12'],
                     '10': ['00', '20'], '11': ['11'], '12': ['02', '22'],
                     '20': ['10', '21'], '21': ['20', '22'], '22': ['12', '21']}
    ...
    def check_win(self,board,moveX,moveY,cur):
        ...
        elif board[0][moveY]==cur and board[1][moveY]==cur and board[2][moveY]==cur:
            return cur
        
        elif moveX==moveY and board[0][0]==cur and board[1][1]==cur and board[2][2]==cur:
            return cur

        elif moveX+moveY==2 and board[0][2]==cur and board[1][1]==cur and board[2][0]==cur:
            return cur
    ...
    def update(self,board,block,move,player):
        ...
        temp_block[block_index] = self.check_win(temp_board,move[0]%3,move[1]%3,player)
    ...
    def alphabeta(self,board,block,old_move,flag,depth,alpha,beta,maximizingPlayer):
        ...
        if maximizingPlayer:
            ...
            for child in next_moves:
                ...
                child_utility = self.alphabeta(temp_board,temp_block,child,flag,depth+1,alpha,beta,False)
            ...
            for child in next_moves:
                ...
                child_utility = self.alphabeta(temp_board,temp_block,child,flag,depth+1,alpha,beta,True)
                if child_utility < utility:
                    utility = child_utility
                    bestchild = child
...
if __name__ == '__main__':
    ...
    """
    block = ['o','-','o','-','-','-','o','-','-']
    board = [['o', 'o', 'o', 'o', 'x', 'x', 'o', 'o', 'o'], ['-', '-', '-', 'x', 'o', 'x', 'x', 'x', '-'], ['x', '-', '-', 'o', '-', '-', '-', '-', 'x'], ['o', '-', 'x', 'o', 'o', '-', 'o', '-', 'x'], ['x', '-', 'x', '-', '-', 'x', '-', 'x', '-'], ['-', 'x', '-', '-', '-', '-', '-', 'x', '-'], ['o', 'o', 'o', '-', '-', '-', '-', '-', '-'], ['-', '-', '-', '-', 'x', '-', '-', '-', '-'], ['-', '-', '-', '-', '-', '-', '-', '-', '-']]
    """
